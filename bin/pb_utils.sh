...
print_revision() {
	echo "$1 v$2 (pb-monitoring-plugins 1.8.15)"
	#printf '%b' "The Monitoring Plugins come with ABSOLUTELY NO WARRANTY. You may redistribute\ncopies of the plugins under the terms of the GNU General Public License.\nFor more information about these matters, see the file named COPYING.\n"
}

support() {
	printf '%b' "Send email to dcops+monitoring@profitbricks.com if you have questions regarding use\nof this software. To submit patches or suggest improvements, send email to\ndcops+monitoring@profitbricks.com. Please include version information with all\ncorrespondence (when possible, use output from the --version option of the\nplugin itself).\n"
}
